...
import { obtenirDemande } from "../api/demandesApi";
import { extraireErreurs } from "../utils/erreurs";
import { libelleStatutDevis } from "../constants/diagnosticChoix";
      ...
      <div className="carte" style={{ maxWidth: 640 }}>
        ...
        <form className="formulaire" onSubmit={gererSoumission}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            ...
            <button type="button" className="bouton bouton--discret" onClick={() => navigate("/affectations")}>
